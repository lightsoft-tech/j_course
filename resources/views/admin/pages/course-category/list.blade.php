...
<div id="kt_content_container" class="container-xxl">
    <div class="card mb-10">
        ...
        <form method="POST" class="form" action="{{url('/back-admin/category-course/store-category-course')}}">
            @csrf
            <div class="card-body p-9">
                <div class="row">
                    ...
                    <div class="col-xl-9 fv-row">
                        <input type="text" class="form-control form-control-solid @error('category_name') is-invalid @enderror" name="category_name" placeholder="Nama Kategori ..." value="{{old('category_name')}}" />
                        @error('category_name')
                        ...
                        <td class="text-center">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <form action="{{url('/back-admin/category-course/'.$item->id.'/edit-category-course')}}" method="POST" class="inline">
                                        @csrf
                                        <button type="submit" class="btn w-100 menu-link px-3 fs-7 text-center">Edit</button>
                                    </form>
                                </div>
                                <div class="menu-item px-3">
                                    <form action="{{url('/back-admin/category-course/'.$item->id.'/destroy-category-course')}}" method="POST" class="inline">
                                        @method('delete')
                                        @csrf
