...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Beranda - Master Data - Divisi & Jabatan - </span>&nbsp;Edit Data Divisi</h1>
        </div>
    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            <div class="card-header">
                <div class="card-title fs-3 fw-bolder">Edit Data Divisi</div>
            </div>
            <form method="POST" class="form" action="{{url('/back-admin/division-position/'.$getDetailDivision->id.'/update-division')}}">
                @method('PUT')
                @csrf
                <div class="card-body p-9">
                    <div class="row">
                        ...
                        <div class="col-xl-9 fv-row">
                            <input type="text" class="form-control form-control-solid @error('division_name') is-invalid @enderror" name="division_name" placeholder="Nama Divisi ..." value="{{old('division_name', $getDetailDivision->division_name)}}" />
                            @error('division_name')
