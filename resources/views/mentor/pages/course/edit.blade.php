...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{url('/back-mentor/course/list-course')}}" class="btn btn-sm btn-primary">Lihat Data</a>
        </div>
    </div>
</div>
@endsection
    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="kt_account_profile_details_form" class="form" method="POST" action="{{url('/back-mentor/course/'.$getCourseDetail->id.'/update-course')}}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
